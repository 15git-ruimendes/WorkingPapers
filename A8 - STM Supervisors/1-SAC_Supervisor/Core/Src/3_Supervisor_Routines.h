...
#define ACTIVE_OK	  	10
#define ACTIVE_H_FAIL 	11
#define ACTIVE_L_FAIL 	12
...
#define START_OK		30
#define START_FAIL		31	
#define INTERRUPT_FAIL	32
...
void RxParser(TypedefSAC *SAC_Card)
{
	...
	if (SAC_Card->Card.rxHeader.DLC < 2)
		return;

	// Parse header
	if (SAC_Card->Card.RxData[0] != SAC_Card->Card.CardId)
		return;
